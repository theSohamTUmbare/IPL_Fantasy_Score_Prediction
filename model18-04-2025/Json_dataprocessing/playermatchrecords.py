...
if __name__ == "__main__":
    global_folder = r"C:\Users\kumar\IPL_Fantasy_Score_Prediction\model18-04-2025\Global_raw_dataset"  # Path to your Global folder containing subfolders.
    output_folder = r"C:\Users\kumar\IPL_Fantasy_Score_Prediction\model18-04-2025\Player_Match_csv"  # Folder to save individual player CSV files.
